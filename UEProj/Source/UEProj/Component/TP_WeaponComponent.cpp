...
bool UTP_WeaponComponent::AttachWeapon(AUEProjCharacter* TargetCharacter)
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("[ERROR] Character is invalid!!"));
		return false;
	}
	UE_LOG(LogTemp, Display, TEXT("[INFO] Character is valid!!"));
	...
	{
		UE_LOG(LogTemp, Display, TEXT("[INFO] Player Controller is valid!!"));
	...
	{
		UE_LOG(LogTemp, Error, TEXT("[ERROR] Player Controller is invalid!!"));	
	}
