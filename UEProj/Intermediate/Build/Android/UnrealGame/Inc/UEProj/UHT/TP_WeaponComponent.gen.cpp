...
#include "UEProj/TP_WeaponComponent.h"
...
UEPROJ_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
UEPROJ_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AUEProjCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AUEProjCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2066124584
...
template<> UEPROJ_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
